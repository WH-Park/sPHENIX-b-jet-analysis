#ifndef __AnaSvtxCell_H__
#define __AnaSvtxCell_H__
...
class AnaSvtxCell: public SubsysReco
{
 public: 
  //Default constructor
  AnaSvtxCell(const std::string &name="AnaSvtxCell");
 ...
 private:
  ...
  int event;
	...
	//G4Cell
	short g4cell_layer[5000];
	short g4cell_stave[5000];
	short g4cell_chip[5000];
	int g4cell_pixel[5000];
