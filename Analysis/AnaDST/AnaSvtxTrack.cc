...
//----------------------------------------------------------------------------//
AnaSvtxTrack::AnaSvtxTrack(const string &name):
  SubsysReco( name ),
  _events( NULL )
{
  //initialize
  _event = 0;
  _outfile = "AnaSvtxTrack.root";
...
//----------------------------------------------------------------------------//
int AnaSvtxTrack::Init(PHCompositeNode *topNode)
{
  ...
  _events->Branch("event",0,"event/I");
	...
	_events->Branch("vtx_gen",0,"vtx_gen[nvertex][3]/F");
	_events->Branch("vtx_reco",0,"vtx_reco[nvertex][3]/F");
	_events->Branch("vtx_id",0,"vtx_id[nvertex]/S");
	//_events->Branch("vtx_reco_err",0,"vtx_reco_err[nvertex][3]/F");
...
//----------------------------------------------------------------------------//
int AnaSvtxTrack::process_event(PHCompositeNode *topNode)
{
  _event++;
  //if (1)
  if (_event % 1000 == 0)
...
//----------------------------------------------------------------------------//
int AnaSvtxTrack::End(PHCompositeNode *topNode)
{

	cout << "-----AnaSvtxTrack::End------" << endl;
...
//----------------------------------------------------------------------------//
void AnaSvtxTrack::fill_tree(PHCompositeNode *topNode)
{
...
//----------------------------------------------------------------------------//
void AnaSvtxTrack::reset_variables()
{
...
//----------------------------------------------------------------------------//
void AnaSvtxTrack::GetNodes(PHCompositeNode * topNode)
{
  //DST objects
	//
